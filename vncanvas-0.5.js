...
var Config = {};
var Stats = {};
// the config, plugins, macros, modpacks are loaded
for (var j in INC) {
	Helper.includeJs(INC[j]);
};
// finally, the script are loaded one at a time
for (var j in TOC) {
	Helper.includeJs(TOC[j]);
};

// TODO: checkpoint load, jump, initial, dynamic load